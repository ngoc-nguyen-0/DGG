...
python3 LCVAEv12.py --dataset "stl10" --resume "" --code_length 10 --batch_size 100 --num_epochs 250
# python3 VaDE.py --dataset "stl10" --resume "" --code_length 10 --batch_size 100 --num_epochs 250
...
# python3 DAE.py --dataset "stl10" --resume "" --code_length 10 --batch_size 100 --num_epochs 250
